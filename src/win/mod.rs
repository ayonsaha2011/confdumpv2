...
pub mod win32_battery;
pub mod win32_cd_rom_drive;
pub mod win32_computer_system_product;
pub mod win32_on_board_device;
pub mod win32_physical_media;
pub mod win32_share;
pub mod win32_system_enclosure;